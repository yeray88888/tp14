...
public:
    ...
    void calcularArea() {
        cout << "area del circulo: " << M_PI * radio * radio << endl;
    }

    void calcularPerimetro() {
        cout << "Perametro del circulo: " << 2 * M_PI * radio << endl;
    }
};
...
public:
    ...
    void calcularArea() {
        cout << "area del rectangulo: " << ancho * alto << endl;
    }

    void calcularPerimetro() {
        cout << "Perametro del rectangulo: " << 2 * (ancho + alto) << endl;
    }
};
...
public:
    ...
    void calcularArea() {
        cout << "area del triangulo: " << 0.5 * base * altura << endl;
    }

    void calcularPerimetro() {
        cout << "Perametro del triangulo: " << "No implementado" << endl;
    }
};
